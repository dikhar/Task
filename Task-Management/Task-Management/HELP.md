...
* The original package name 'com.example.Task-Management' is invalid and this project uses 'com.example.TaskManagement' instead.
...
* [Spring Data JDBC](https://docs.spring.io/spring-boot/docs/3.1.6-SNAPSHOT/reference/htmlsingle/index.html#data.sql.jdbc)
